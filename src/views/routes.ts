...
export const routes = [
  ...
  // Add a page to site with custom properties
  { path: '/sites/:sitekey/craft/page', component: () => import('./pages/CraftPageView.vue'), props: true },
  ...
  { path: '/sites/:sitekey/pages/:pagekey/delete', component: () => import('./pages/DeletePageView.vue'), props: true },
  ...
  // Views related to the "Player Characters" feature
  { path: '/library/characters', component: () => import('./library/UserCharactersView.vue') },
